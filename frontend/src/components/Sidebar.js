...
function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '0 20px', marginBottom: '10px', display: 'flex', justifyContent: 'flex-end' }}>
        <SettingsButton onClick={() => setKeyModalOpen(true)} title="Manage API Keys">
          <Key size={14} />
          <span style={{ marginLeft: '6px', fontSize: '11px', fontFamily: "'Orbitron', sans-serif" }}>KEYS</span>
        </SettingsButton>
      </div>
